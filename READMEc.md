...
Так, быз создан виджет "Расчет электропотребления и его стоимости", состоящий из двух страниц. Переход между страницами осуществляется по нажатию кнопки "Далее".    
